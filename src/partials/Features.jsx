...
import LayoutImage from '../images/layouts.png';
import EditorImage from '../images/editor.png';
import LabelsImage from '../images/labels-pdf.png';
...
function Features() {
  ...
  return (
    <section className="relative">
      ...
      <div className="relative max-w-6xl mx-auto px-4 pb-20 sm:px-6">
            ...
            <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6 " data-aos="fade-right">
              ...
              <div className="my-8 md:mb-0">
                ...
                >
                  ...
                  <div className="font-bold leading-snug  tracking-tight">Choose your layout</div>
                ...
                >
                  ...
                  <div>
                    <div className="font-bold leading-snug tracking-tight">Design your label</div>
                ...
                >
                  ...
                  <div>
                    <div className="font-bold leading-snug tracking-tight">Print</div>
